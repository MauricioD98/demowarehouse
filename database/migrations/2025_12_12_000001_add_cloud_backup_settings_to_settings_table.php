...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('settings', function (Blueprint $table) {
            ...
            $table->string('backup_s3_bucket', 191)->nullable();
            $table->string('backup_s3_region', 191)->nullable();
            $table->string('backup_s3_access_key', 191)->nullable();
            ...
            $table->string('backup_gdrive_folder_id', 191)->nullable();
